  ...
  return (
   ...
   <div className="h-full px-3 py-4 overflow-y-auto bg-gray-50 dark:bg-gray-800 background-aside">
      <div  className="flex items-center ps-2.5 mb-5">
         <span className="self-center text-xl font-semibold whitespace-nowrap dark:text-white color-text-aside">MyScraper</span>
      </div>
      <ul className="space-y-2 font-medium">
         <Link href='/addWebsite'>
            ...
            <svg className="flex-shrink-0 w-5 h-5 text-gray-500 transition duration-75 group-hover:text-gray-900 dark:text-gray-400 dark:group-hover:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 18 21">
               ...
               <div  className="ms-3 color-text-aside group-hover:text-black ">Website</div>
            </div>
         </Link>
         <Link href='/dashboard'>
            <div className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
               ...
               <div className="flex-1 ms-3 whitespace-nowrap color-text-aside  group-hover:text-black">Dashboard</div>
            </div>
         </Link>
         <Link href='/addProduct'>
            ...
            <svg className="flex-shrink-0 w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 18 20">
               ...
               <div className="flex-1 ms-3 whitespace-nowrap color-text-aside  group-hover:text-black">Product</div>
            </div>
         </Link>
      </ul>
   </div>
